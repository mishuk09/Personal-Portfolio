...
//         data - ride = "carousel" > { /* Your other content */ } { /* Sample carousel items, replace with your content */ } <
//         h1 > TESTIMONIALS < /h1> <
...
//         div className = 'name-div-tes' > < h3 > Shivangi Patel < img className = ' '
//         src = { indiaflag }
//         alt = "" / > < /h3> <
//         span > Assistant Professor < /span><hr / >
//         <
//         /div> <h5>Rk University,Rajkot,Gujarat,India.</h
//         5 >
//         <
//         div className = 'social-link pt-6 ' >

//         <
//         div className = 'pe-4  w-' > < FontAwesomeIcon className = 'testimonier-div-icon'
//         icon = { faLinkedin }
//         /></div >
//         <
//         div className = 'pe-4  w-' > < FontAwesomeIcon className = 'testimonier-div-icon'
...
//         <
//         p > I have tried a lot of food delivery services but Plate is something out of this world!Their food is really healthy and it tastes great, which is why I recommend this company to all my friends! < /p> <
//         div className = 'name-div-tes' > < h3 > SHALINI JHA < img src = { indiaflag }
//         alt = "" / > < /h3> <
...
//         <
//         p > I have tried a lot of food delivery services but Plate is something out of this world!Their food is really healthy and it tastes great, which is why I recommend this company to all my friends! < /p> <
//         div className = 'name-div-tes' > < h3 > NUR ALOM < img src = { fiverr }
//         alt = "" / > < img src = { bdflag }
//         alt = "" / > < /h3> <
