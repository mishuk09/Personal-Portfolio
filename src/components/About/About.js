    ...
    return (
        <div id='about' className='  container aboutme-main-pic'>
            <div className=' container   about-section'>
                ...
                <div className='resume'><a href="https://drive.google.com/file/d/1RxHEtDv3SZSiKcLzXsbc1NPoICIdjl1l/view?usp=sharing" target='blank'><button>Resume <FontAwesomeIcon icon={faDownload} /></button></a>  </div>
