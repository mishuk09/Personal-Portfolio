...
const tabs = [
  ...
  },
  {
    ...
    bgColor: "#d5a229",
    imgUrl:
      "https://www.iium.edu.my/v2/wp-content/uploads/2022/06/IIUM_TAWHIDIC_UMMATIC_KHALIFAH.png",
  },
];

const institutions = [
  { name: "MMU Main Campus", sessions: "12 sessions", albums: "145 photos" },
  { name: "Business School", sessions: "8 sessions", albums: "96 photos" },
];
            ...
            <div className="overflow-hidden grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="">
                <article className="rounded-2xl  items-center text-center justify-center border border-slate-200 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-sm text-slate-600">236 photos</p>
                  <a
                    href="https://drive.google.com/drive/folders/1-dhCfAz2cL7dsBmjtzmaSh_F5SxT2GEA?usp=sharing"
                    target="_blank"
                    rel="noreferrer"
                    type="button"
              ...
              <div className="">
                <article className="rounded-2xl  items-center text-center justify-center border border-slate-200 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-sm text-slate-600">48 Videos</p>
                  <a
